...
const ActivitiesCare = ({setProgress}) => {
        ...
        const  ActivityCard = ({ title, center, content, shortText,date ,img}) => (
            ...
            <Grid gutter={30} p={10}>
              <Grid.Col span={12}>
                <Flex dir="ltr" justify="space-between" align="center" px={10}>
                    <Group display={'flex'} gap={5} justify="start" align="center">
                        <Text size="sm">{center}</Text>
                         {/* <PenLine size={15} /> */}
                    </Group>
                  
                  <Title size="xl" ta={'right'}>{title}</Title>
                </Flex>
